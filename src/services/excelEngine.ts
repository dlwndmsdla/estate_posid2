...
export function generateSampleExcelTemplate(): void {
  ...
  const sampleRow1 = [
    ...
    "알스퀘어", "2026-06-30", "2026-06-30", 0, "RS-1001", "임대", "서울", "영등포", 1.2069, 0.1172, 0.0391, 0.1229, 105, 10.2, 3.4, 87, 3, "(예시) 샘플오피스 A동", "서울특별시 영등포구 양평로 21", 2005, 37.5312, 126.9012, "1156011000100210000", 520, "업무시설", 18500, 15, 4, 120, "무료", 0.056
  ];

  const sampleRow2 = [
    "네모", "서울", "영등포", "업무시설", 1.0345, 0.0991, 0.0328, 0.1039, 5, "중", 280, "",
    "네모", "2026-06-30", "2026-06-30", 0, "NEMO-2002", "임대", "서울", "영등포", 1.0345, 0.0991, 0.0328, 0.1039, 120, 11.5, 3.8, 116, 5, "(예시) 샘플오피스 B동", "서울특별시 영등포구 선유동3로 15", 2002, 37.5345, 126.8998, "1156011000100150000", 280, "업무시설", 15800, 12, 3, 95, "무료", 0.056
  ];
